...
```
  ...
  # Initialize the source, using selecting a non-default namespace the IBM Metrics Operator dataService was installed to.
  datactl sources add --namespace=redhat-marketplace
```
