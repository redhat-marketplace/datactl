...
func autoConvert_v1_Config_To_api_Config(in *Config, out *api.Config, s conversion.Scope) error {
	...
	// WARNING: in.MeteringExports requires manual conversion: inconvertible types ([]*./v1.MeteringExport vs map[string]*github.com/redhat-marketplace/datactl/pkg/datactl/api.MeteringExport)
	// WARNING: in.DataServiceEndpoints requires manual conversion: inconvertible types ([]*./v1.DataServiceEndpoint vs map[string]*github.com/redhat-marketplace/datactl/pkg/datactl/api.DataServiceEndpoint)
	// WARNING: in.Sources requires manual conversion: inconvertible types ([]*./v1.Source vs map[string]*github.com/redhat-marketplace/datactl/pkg/datactl/api.Source)
	return nil
}
...
func autoConvert_api_Config_To_v1_Config(in *api.Config, out *Config, s conversion.Scope) error {
	...
	// WARNING: in.MeteringExports requires manual conversion: inconvertible types (map[string]*github.com/redhat-marketplace/datactl/pkg/datactl/api.MeteringExport vs []*./v1.MeteringExport)
	// WARNING: in.DataServiceEndpoints requires manual conversion: inconvertible types (map[string]*github.com/redhat-marketplace/datactl/pkg/datactl/api.DataServiceEndpoint vs []*./v1.DataServiceEndpoint)
	// WARNING: in.Sources requires manual conversion: inconvertible types (map[string]*github.com/redhat-marketplace/datactl/pkg/datactl/api.Source vs []*./v1.Source)
	return nil
}
